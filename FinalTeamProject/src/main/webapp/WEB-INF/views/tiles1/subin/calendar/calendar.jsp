              ...
              <li style="padding: 10px 0 0;">
                  ...
                  <div class="add_calendar_box dropdown">
                  	...
                  	<div class="dropdown-menu" aria-labelledby="dropdownMenuLink" style="padding: 5px 0; padding-left: 20xp; padding-right: 20xp;">
                  		<h5>내 캘린더 추가</h5>
                  		<div>
                  			<input type="text" maxlength="16" name="cal_name" />
                  			<br>
                  			<button type="button" class="btn btn-default" onclick="addCal()">확인</button>
	     ...
	     <div class="modal-body">
	       ...
	       <div class="modal_container">
				...
				<div style="float: right;">
					<button class="btn btn-default" type="button" onclick="addDetailSchModalBtn()">일정상세 입력</button>
					<button class="btn btn-default" type="button" onclick="addSchModalBtn()">등록</button>
				</div>
				<br style="clear: both;">
			   </form>
			</div>
