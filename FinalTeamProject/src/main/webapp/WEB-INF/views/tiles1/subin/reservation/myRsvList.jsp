...
<body class="stop-dragging">
	...
	<div class="container">   
	  ...
	  <div class="add_cal_Box">
	  	...
	  	<button type="button" class="btn btn-info" onclick="addCal()">추가</button>
	...
	<div style="text-align: center;">
		<button class="btn btn-default" onclick="backCal()">캘린더로</button>
	</div>
	   ...
	   <div class="modal-content">
	     ...
	     <div class="modal-body">
	       <div class="container">
				...
				<button class="btn btn-default" style="float: right;" type="button" onclick="editCalNameBtn()">수정</button>
			   </form>
			</div>
	     </div>
	   </div>
