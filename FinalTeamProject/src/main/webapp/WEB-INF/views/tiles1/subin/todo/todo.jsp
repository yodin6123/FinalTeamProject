	   ...
	   <div class="modal-content">
	     ...
	     <div class="modal-body">
	       <div class="container">
				...
				<button class="btn btn-default" style="float: right;" type="button" onclick="editTodoBtn()">수정</button>
				<button class="btn btn-default" style="float: right; margin-right: 3px;" type="button" onclick="deleteBtn()">일정 삭제</button>
			   </form>
			</div>
	     </div>
	   </div>
	     ...
	     <div class="modal-body">
            <div class="container">
				<form name="addTodoFrm">
					...
					<button class="btn btn-default" style="float: right;" type="button" onclick="submitBtn()">등록</button>
				</form>
			</div>
	     </div>
	   </div>
