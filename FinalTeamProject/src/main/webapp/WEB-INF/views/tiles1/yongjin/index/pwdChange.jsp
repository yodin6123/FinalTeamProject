...
<script type="text/javascript">
	...
	function pwdRevise() {
		...
		var test = regExp.test(before_pwd);
		
		if(!test) {
			$("span#requireBefore_pwd").show();
			$("input#before_pwd").empty();
			return;
		} else {
			$("span#requireBefore_pwd").hide();
		}// end of if(!test) {}----------------------
		...
		if(!test) {
			$("span#requireEmp_pwd").show();
			$("input#emp_pwd").empty();
			return;
		} else {
			$("span#requireEmp_pwd").hide();
		}// end of if(!test) {}----------------------
		...
		if(emp_pwd != emp_pwd_check) {
			$("span#requireEmp_pwd_check").show();
			$("input#emp_pwd_check").empty();
			return;
		} else {
			$("span#requireEmp_pwd_check").hide();
		}// end of if(!test) {}----------------------
