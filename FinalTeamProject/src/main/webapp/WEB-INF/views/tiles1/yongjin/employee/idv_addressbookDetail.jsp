...
<div id="content">
	...
	<div class="content_page">
			...
			<fieldset>
				<table class="form_type">
					...
					<tr>
						...
						<td>
							<textarea rows="5" cols="40">${pbvo.memo}</textarea>
						</td>
					</tr>
		...
		<div class="page_action_wrap">
			...
			<a id="contactDelete" data-bypass="" class="btn_caution" data-role="button"><span class="txt">삭제</span></a>
		</div>
	</div>
</div>

<!-- ===== 주소 등록 Modal ===== -->
<div class="modal fade" id="gpopupLayer" role="dialog" data-id="1f8c4968-a7f8-4597-8e6e-b70da685aa3c" data-close="false" style="width: 300px; top: 146px; position: fixed; left: 369px;" data-layer="">
				...
				<span id="popupContent">
					<form name="formAddrDetail">
						<table class="table_form_mini">
							<tbody>
								<tr>
									<td><button type="button" id="postcodeSearch">우편번호 찾기</button></td>			
								</tr>
								<tr>
									<th><span class="txt">우편번호</span></th>
									<td><input name="postcode" id="modalPostcode" class="txt_mini" type="text" value="${pbvo.postcode}" readonly="readonly"></td>			
								</tr>
								<tr>
									<th><span class="txt">주소</span></th>
									<td><input name="address" id="modalAddress" class="txt_mini" type="text" value="${pbvo.address}" readonly="readonly"></td>			
								</tr>
								<tr>
									<th><span class="txt">상세주소</span></th>
									<td><input name="detail_address" id="modalDetail_address" class="txt_mini" type="text" value="${pbvo.detail_address}"></td>			
								</tr>
								<tr>
									<th><span class="txt">주소 참고항목</span></th>
									<td><input name="extra_address" id="modalExtra_address" class="txt_mini" type="text" value="${pbvo.extra_address}" readonly="readonly"></td>			
								</tr>
							</tbody>
						</table>
					</form>	
